...
export default function Settings() {
  const { 
    ...
    isDeviceLicensed, isLicensed, licenseExpiry, isSharedCompany
  } = useApp();
...
`;
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 md:space-y-12 px-4 md:px-0">
      ...
      <section>
        ...
        <div className="bg-white dark:bg-white rounded-3xl border border-slate-100 dark:border-slate-200 shadow-sm overflow-hidden">
          <div className="divide-y divide-slate-50 dark:divide-slate-800">
            ...
            {/* Cloud Sync - Hidden for shared users */}
            {!isShared && (
      ...
      {/* Backup & Restore - HIDDEN FOR SHARED USERS */}
      {!isShared && (
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 p-8 shadow-sm">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <p className="font-bold text-slate-900 dark:text-white">Create Backup</p>
