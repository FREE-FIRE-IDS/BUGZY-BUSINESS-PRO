    ...
    <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-black">{lowStockItems.length}</p>
            </div>
          </div>
        </div>
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button 
            onClick={exportPDF}
            className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-all text-black font-medium"
          >
            <Download size={18} />
            PDF
          </button>
      ...
      <div className="bg-white dark:bg-slate-100 rounded-3xl border border-slate-100 dark:border-slate-200 shadow-sm overflow-hidden">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-200">
              {filteredItems.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50 dark:hover:bg-slate-200/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm font-bold text-right text-black">{formatCurrency(item.price, settings.currency)}</td>
