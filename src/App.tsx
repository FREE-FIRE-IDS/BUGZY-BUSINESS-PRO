  ...
  useEffect(() => {
    if (authReady) {
      const timer = setTimeout(() => {
        setShowSplash(false);
      }, 1500); // Shorter splash once auth is ready
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl p-10 border border-slate-100 dark:border-slate-800 text-center">
        <motion.div 
          initial={{ y: -20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          className="w-24 h-24 bg-indigo-600 rounded-[2rem] flex items-center justify-center text-white shadow-2xl shadow-indigo-500/20 mx-auto mb-8"
        >
          <Building2 size={48} />
        </motion.div>
        
        <h1 className="text-3xl font-black text-slate-900 dark:text-slate-50 mb-2 tracking-tight">Bugzy Pro SaaS</h1>
        <p className="text-slate-500 dark:text-slate-400 mb-10 leading-relaxed font-medium">
          Professional SaaS solution with real-time sync across all your devices.
        </p>
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white dark:bg-slate-900 px-4 text-slate-400 font-black tracking-widest">Or</span>
              </div>
            </div>

            <button 
              onClick={() => setShowUsernameLogin(true)}
              className="w-full py-4 text-slate-500 dark:text-slate-400 font-bold hover:text-indigo-600 transition-all text-sm bg-slate-50 dark:bg-slate-800/30 rounded-2xl border-2 border-transparent hover:border-indigo-100 dark:hover:border-indigo-900/30"
            >
              Use Username Login
            </button>
          </div>
