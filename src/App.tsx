    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl p-10 border border-slate-100 dark:border-slate-800 text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-10 leading-relaxed font-medium">
          Sign in with your Google account to sync your business across all devices.
        </p>

        <button 
          onClick={handleLogin}
          disabled={isLoading}
          className="w-full bg-white dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 text-slate-900 dark:text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-slate-50 dark:hover:bg-slate-750 transition-all shadow-lg active:scale-95 disabled:opacity-50"
        >
          {isLoading ? (
