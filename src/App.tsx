    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl p-10 border border-slate-100 dark:border-slate-800 text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-10 leading-relaxed font-medium">
          Secure business management with real-time sync across all your devices.
        </p>
        ...
        {!showUsernameLogin ? (
          <div className="space-y-4">
            <button 
              ...
              disabled={isLoading}
              className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black flex items-center justify-center gap-3 hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/20 active:scale-95 disabled:opacity-50"
            >
              {isLoading ? (
            ...
            <button 
              ...
              className="w-full py-4 text-slate-500 font-bold hover:text-indigo-600 transition-all text-sm"
            >
              Or use Username fallback
            </button>
          </div>
        ) : (
